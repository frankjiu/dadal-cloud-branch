...
public interface RoleDao {
    ...
    List<Role> findPage(@Param("dto") RoleGetDto dto) throws Exception;

    int count(@Param("dto") RoleGetDto dto) throws Exception;

    @Options(useGeneratedKeys = true, keyProperty = "id")
    @Insert("INSERT INTO role(ROLE_NAME, REMARK, UPDATE_TIME) values(#{role.roleName}, #{role.remark}, #{role.updateTime})")
