...
public class ExportData {
    ...
    public <E> void exportData(String jsonStr, Class<E> clz, HttpServletRequest request, HttpServletResponse response) throws Exception {
        /** 获取数据 */
